...
@ControllerAdvice
@RestController   /** Use this annotation here otherwise you will get Error - "Whitelabel Error" in the browser when you hit a URL with method that is not defined in your server (HttpRequestMethodNotSupportedException) which throws an exception (This application has no explicit mapping for /error, so you are seeing this as a fallback) */
